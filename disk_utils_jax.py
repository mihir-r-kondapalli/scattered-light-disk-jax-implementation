...
def jax_disk_model_hg2(inc,pa,alpha_in,alpha_out,a, cent,gs_ws,flux_scaling,
    ...
    disk = ScatteredLightDisk(nx=nx, ny=ny, distance=dstar,
                                ...
                                spf_dico={'name':'DoubleHG', 'g': [0.5, -0.3], 'weight': 0.7, 'polar':False},
                                flux_max=1)
...
def jax_disk_model_hg(inc,pa,alpha_in,alpha_out,a, cent,gs_ws,flux_scaling,
                    ksi0=3.,gamma=2.,beta=1.,dstar=111.61,
                    nx=140,ny=140,pixel_scale=0.063,n_nodes=6):
    '''
    Make a single disk model! 
